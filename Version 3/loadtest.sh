...
rm ./queue-size-dir/queue_length.txt
touch ./queue-size-dir/queue_length.txt
...
avg_queue_size=$(awk '{count+=$1} END{print count/NR}' ./queue-size-dir/queue_length.txt)

echo "Average number of requests in the queue: $avg_queue_size"
