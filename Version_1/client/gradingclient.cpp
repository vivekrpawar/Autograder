// version 1 client and V2
//  ./submit  <serverIP:port>  <sourceCodeFileTobeGraded> <loopNum> <sleepTimeSeconds>

// client V1 with mams way of reading and sending file and timeout
// with Performance Experiment Setup
//  Number of successful requests/second in the experiment - this is called throughput
//  Average response time of a request in the experiment.
