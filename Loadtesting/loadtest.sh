...
do	 
	...
	~/Documents/CS744/23M0769-23M0805/Version_3/client/gradingclient 127.0.0.1 8080 ~/Documents/CS744/23M0769-23M0805/Version_3/client/program_runs.cpp $2 $3 $4 1>$filename &
done
wait
